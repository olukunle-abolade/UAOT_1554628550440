...
import { FindJobEditComponent} from './pages/find-job-edit/find-job-edit.component';
...
const routes: Routes = [
    ...
    { path: 'findjobs/:id',  loadChildren: './pages/find-job-edit/find-job-edit.module#FindJobEditModule'  },
